...
- **Tarjeta Arduino Uno**: Descripción 
![componente1](assets/img/Semana3/componente1)

- **Cable Arduino Uno**: Descripción 
![componente2](assets/img/Semana3/componente2)

- **Protoboard**: Descripción 
![componente3](assets/img/Semana3/componente3)

- **Cables macho**: Descripción 
![componente4](assets/img/Semana3/componente4)

- **Leds**: Descripción 
![componente5](assets/img/Semana3/componente5)

- **Botones**: Descripción 
![componente6](assets/img/Semana3/componente6)

- **Resistencias**: Descripción 
![componente7](assets/img/Semana3/componente7)

- **Contador Led**: Descripción 
![componente8](assets/img/Semana3/componente8)

- **Servomotores**: Descripción 
![componente9](assets/img/Semana3/componente9)

- **Potenciometro**: Descripción 
![componente10](assets/img/Semana3/componente10)

- **Cajita Bonita**: Descripción 
![componente11](assets/img/Semana3/componente11)
